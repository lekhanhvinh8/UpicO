...
namespace Upico.Core.Repositories
{
    public interface IPostRepository : IRepository<Post>
    {
        ...
        public Task<IList<Post>> GetPosts(string username, bool getPrivatePost, int numPosts);
        public Task<IList<Post>> GetPostsBefore(string username, string latestPostId, bool getPrivatePost, int numPosts);
